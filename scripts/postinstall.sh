...
./node_modules/.bin/browserify data-service/index.js -s ds -u ts-utils -u @turtlenetwork/signature-generator -u ramda --no-bf -o ./data-service-dist/data-service.js || exit 1
