(function () {
    ...
    var ZERO_MONEY = Money.fromTokens(0, Currency.TN);
    ...
    function WavesMassPaymentController ($scope, $window, $timeout, constants, events, applicationContext, autocomplete,
        ...
        $scope.$on(events.ASSET_MASSPAY, function (event, eventData) {
            ...
            mass.sendingWaves = mass.assetBalance.currency === Currency.TN;
        ...
        function loadTransactionsFromFile() {
            ...
            try {
                ...
                var totalFee = Money.fromCoins(0, Currency.TN);
                var fee = Money.fromTokens(mass.autocomplete.getFeeAmount(), Currency.TN);
        ...
        function cleanup() {
            ...
            mass.confirm.amount = Money.fromTokens(0, Currency.TN);
            mass.confirm.recipients = 0;
            mass.confirm.fee = Money.fromTokens(0, Currency.TN);
